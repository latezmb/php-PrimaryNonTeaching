...
if (isset($_SESSION['name'])) {
    if (isset($_GET['typename'])) {
        ...
        if (isset($_POST['year'])) {
            ...
            $id = $_POST['id'];
            $statement1 = "UPDATE work SET year=?,teacherId=?,bigType=?,typeName=?,rankName=?,content=?,classHour=?,money=? where id=?";
            ...
            if ($boo) {
                ...
                if ($row > 0) {
                    echo "<script language=\"JavaScript\">alert(\"修改成功！\");location.href='feimywork.php?typename=feimywork';</script>";
                    exit();
                } else {
                    echo "<script language=\"JavaScript\">alert(\"修改失败！\");location.href='feimywork.php?typename=feimywork';</script>";
                    exit();
                }
            } else {
			...
			<div class="col-md-8 col-md-offset-0">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" id="workform" action="bianjifeimywork.php"
							method='post'>
