...
if (isset($_SESSION['name'])) {
    ...
    if (isset($_POST['year']) && isset($_POST['bigType'])) {
        ...
        if ($bigType == "") {
            $statement = "select * from work where teacherId=? and year=?";
            ...
            $boo = $statementObject->execute(array(
             ...
             $statement = "select * from work where teacherId=? and year=? and bigType=?";
            $statementObject = $pdo->prepare($statement);
            $boo = $statementObject->execute(array(
               $teacherId,
                $year,
        ...
        $statement = "select * from work where teacherId=?";
        $statementObject = $pdo->prepare($statement);
        $boo = $statementObject->execute(array(
            $teacherId
        ));
...
<div id="page-wrapper">
	...
	<div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				<form action="feimywork.php?typename=feimywork" method="post">
					&nbsp;&nbsp;&nbsp;&nbsp; 年度：<select name="year">
					...
					</select> 大类：<select id="bigType" name="bigType">
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href='insertfeimytwork.php?typename=insertwork'
							class="btn btn-primary">新增非授课工作</a>
					</div>
        ...
        foreach ($data as $information) {
            ...
            if ($information['status'] == "确认") {
                ...
                echo "
                                                            <a href='bianjifeimywork.php?typename=" . $information['id'] . "' class='btn btn-primary btn-xs'><i class='fa fa-edit'>&nbsp;编辑</i></a>&nbsp;&nbsp;
            ...
            ?>
											&nbsp;&nbsp;
											<a
											href="deleteinformation.php?feimyworkid=<?= $information['id']?>"
