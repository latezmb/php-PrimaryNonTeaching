...
if (isset($_SESSION['name'])) {
    if (isset($_POST['year'])) {
        ...
        $statement = "insert into teachhour(year,status,teacherId,classHour,recorder) values(?,?,?,?,?)";
        ...
        if ($boo) {
            ...
            if ($row > 0) {
                echo "<script language=\"JavaScript\">alert(\"添加成功！\");location.href='adminworkmanagement.php?typename=adminworkmanagement';</script>";
                exit();
            }
        } else {
            echo "系统内部出错！请稍后再试！";
			...
			<div class="col-md-8 col-md-offset-0">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" id="workform" action="insertworks.php"
							method='post'>
