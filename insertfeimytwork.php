...
if (isset($_SESSION['name'])) {
    if (isset($_POST['year'])) {
        ...
        $money = $_POST['money'];
        $statement = "insert into work(year,teacherId,bigType,typeName,rankName,content,classHour,money) values(?,?,?,?,?,?,?,?)";
        ...
        if ($boo) {
            ...
            if ($row > 0) {
                echo "<script language=\"JavaScript\">alert(\"添加成功！\");location.href='feimywork.php?typename=feimywork';</script>";
                exit();
            } else {
                echo "<script language=\"JavaScript\">alert(\"添加失败！\");location.href='feimywork.php?typename=feimywork';</script>";
                exit();
            }
        } else {
			...
			<div class="col-md-8 col-md-offset-0">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" id="workform" action="insertfeimytwork.php"
							method='post'>
							...
							<div class="form-group input-group">
								...
								<input type="text" readOnly="true" class="form-control"
									placeholder="教工号" name='teacherId' maxlength="15"
									id='teacherId' value=<?= $_SESSION['username'] ?> />
							</div>
							<div class="form-group input-group">
							...
							<input type='submit' name="save" class="btn btn-primary"
								...
								href="feimywork.php?typename=feimywork">放弃</a>
						</form>
					</div>
				</div>
			</div>
