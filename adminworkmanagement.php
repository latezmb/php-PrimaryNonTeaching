...
if ($_SESSION['name']) {
    ...
    if (isset($_POST['year'])) {
        $year = $_POST['year'];
        $statement = "select A.name,B.* from user A join teachhour B on A.username=B.teacherId where B.year=?";
        ...
        $statement = "select A.name,B.* from user A join teachhour B on A.username=B.teacherId";
        $statementObject = $pdo->prepare($statement);
...
<div id="page-wrapper">
	...
	<div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				<form action="adminworkmanagement.php?typename=adminworkmanagement" method="post">
					&nbsp;&nbsp;&nbsp;&nbsp; 年度：<select name="year">
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href='insertworks.php?typename=insertworks'
        ...
        foreach ($data as $information) {
            ?>
										...
										<td><a
											href="bianjiworks.php?typename=<?= $information['id']?>"
											class='btn btn-primary btn-xs'><i class='fa fa-edit'>&nbsp;编辑</i></a>&nbsp;&nbsp;
											<a
											href="deleteinformation.php?adminworkmanagementid=<?= $information['id']?>"
